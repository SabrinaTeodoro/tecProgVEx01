...
function addTarefa(event, form){
    event.preventDefault();//evita que o comportamento padrao a ser disparado ocorre
    /* console.log(form.inputTarefa.value);
    console.log(form.btnSalvar.innerText); */
    //
    //CATTO'S JUMP -> "inputTarefa" é o id 
    //de um elemento que esta DENTRO de form
    //

    /* const pai = document.getElementById("tarefas");
    const inputTarefa = document.getElementById("inputTarefa"); */
    
    let novaTarefa = form.inputTarefa.value.trim();
